...
def handlebar(ContextInfo):
    ...
    if now_struct.tm_min % 5 == 0 and now_struct.tm_min != last_executed_minute:
        ...
        def print_ma_detail(code, trend, c_series, curr_p, ratio):
            ...
            print("\n" + "=" * 90)
            print("  [{}] {} {}  现价={:.4f}  涨跌={:+.2f}%".format(trend, code, name, curr_p, ratio))
            print("-" * 90)
            ...
            c1 = m5 > m10 > m20 > m30 > m60
            c2 = m5 > p5 and m10 > p10
            print("-" * 90)
            print("  完整多头={} | m5>p5且m10>p10={} | 最终判定={}".format(c1, c2, trend))
            print("=" * 90)
        # ========== DEBUG END ==========
